...
<head>
    <title>Code coverage report for encodeVarInt.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> encodeVarInt.ts</h1>
        <div class='clearfix'>
...
export function encodeVarInt(i: bigint | number): Buffer {
    ...
    else <span class="missing-if-branch" title="else path not taken" >E</span>if (i &lt; BigInt("0x10000000000000000")) {
...
<span class="cstat-no" title="statement not covered" >        throw new Error(`Integer too large ${i}`);</span>
    }
}
&nbsp;</pre></td></tr></table></pre>
