...
<head>
    <title>Code coverage report for StreamReader.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> StreamReader.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Readable } from "stream";
...
&nbsp;
    ...
    public readVarInt(): bigint {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (byte === 0xff) return this.readBigUInt64LE();
    }
&nbsp;
    /**
    ...
    public readBigSize(): bigint {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (byte === 0xff) return BigInt(this.readBigUInt64BE());
    }
&nbsp;
    /**
