...
<head>
    <title>Code coverage report for BufferReader.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> BufferReader.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">94.74% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>126/133</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import assert from "assert";
&nbsp;
/**
...
&nbsp;
     ...
     */
    public <span class="fstat-no" title="function not covered" >readTUInt16(</span>): number {
        const size = <span class="cstat-no" title="statement not covered" >Math.min(2, this._buffer.length - this._position);</span>
<span class="cstat-no" title="statement not covered" >        if (size === 0) <span class="cstat-no" title="statement not covered" >return 0;</span></span>
        const val = <span class="cstat-no" title="statement not covered" >this._buffer.readUIntBE(this._position, size);</span>
<span class="cstat-no" title="statement not covered" >        this._assertMinimalTUInt(BigInt(val), size);</span>
<span class="cstat-no" title="statement not covered" >        this._position += size;</span>
...
&nbsp;
    ...
    public readTUInt64(): bigint {
        ...
        const hex =
            this._buffer.slice(this._position, this._position + size).toString("hex") || <span class="branch-1 cbranch-no" title="branch not covered" >"0";</span>
