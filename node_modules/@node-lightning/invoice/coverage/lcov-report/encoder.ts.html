...
<head>
    <title>Code coverage report for encoder.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> encoder.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">98.8% </span>
    ...
    for (const datum of invoice.fields) {
        switch (datum.type) {
            ...
            case FIELD_TYPE.MIN_FINAL_CLTV_EXPIRY:
                ...
                break;
            default: {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!(datum.value instanceof Buffer)) {
<span class="cstat-no" title="statement not covered" >                    throw new Error("Cannot process unknown field");</span>
                }
                const dataLen = bech32Util.sizeofBytes(datum.value.byteLength);
                writer.writeUIntBE(datum.type, 1);
                writer.writeUIntBE(dataLen, 2);
