...
<head>
    <title>Code coverage report for invoice.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> invoice.ts</h1>
        <div class='clearfix'>
...
<a name='L352'></a><a href='#L352'>352</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* eslint-disable @typescript-eslint/no-unsafe-call */
...
&nbsp;
    public set paymentHash(value) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof value === "string") <span class="cstat-no" title="statement not covered" >value = Buffer.from(value, "hex");</span>
...
&nbsp;
        ...
        if (addrStr.startsWith("1") || addrStr.startsWith("m") || addrStr.startsWith("n")) {
            ...
            address = bs58check.decode(addrStr).slice(1); // remove prefix
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (addrStr.startsWith("bc1") || addrStr.startsWith("tb1")) {
...
&nbsp;
    ...
    public addRoute(routes: Route[]) {
        for (const route of routes) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof route.pubkey === "string") <span class="cstat-no" title="statement not covered" >route.pubkey = Buffer.from(route.pubkey, "hex");</span>
            <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof route.short_channel_id === "string") {
<span class="cstat-no" title="statement not covered" >                route.short_channel_id = Buffer.from(route.short_channel_id, "hex");</span>
            }
        }
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Nov 07 2022 14:49:33 GMT-0500 (Eastern Standard Time)
            </div>
        </div>
