...
function encodePico(pico) {
    ...
    return (BigInt(pico) / hrp_pico_1.hrpToPico(hrpMultiplier)).toString() + hrpMultiplier;
}
exports.encodePico = encodePico;
///////////////////////////////////////////////////////////////////////////////
/**
...
function _lsdIndex(msatStr) {
    for (let i = msatStr.length - 1; i >= 0; i--) {
        if (Number(msatStr[i]) !== 0)
            return msatStr.length - i - 1;
    }
...
//# sourceMappingURL=encode-pico.js.map