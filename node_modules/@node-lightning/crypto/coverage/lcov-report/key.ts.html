...
<head>
    <title>Code coverage report for key.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> key.ts</h1>
        <div class='clearfix'>
...
<a name='L76'></a><a href='#L76'>76</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import crypto from "crypto";
 ...
 * @returns
 */
export function convertPublicKey(pubkey: Buffer, compressed: boolean = <span class="branch-0 cbranch-no" title="branch not covered" >true)</span>: Buffer {
