...
<head>
    <title>Code coverage report for secp256k1.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> secp256k1.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import secp256k1 from "@node-lightning/secp256k1";
&nbsp;
/**
 ...
 * @param privateKey 32-byte secp256k1 private key
 */
export function <span class="fstat-no" title="function not covered" >signWithRecovery(</span>
    msg: Buffer,
    privateKey: Buffer,
): { signature: Buffer; recovery: number } {
    const { signature, recid } = <span class="cstat-no" title="statement not covered" >secp256k1.ecdsaSign(msg, privateKey);</span>
 ...
 */
export function <span class="fstat-no" title="function not covered" >recoverPubKey(</span>
    signature: Buffer,
    recovery: number,
    message: Buffer,
    compressed: boolean = <span class="branch-0 cbranch-no" title="branch not covered" >true,</span>
): Buffer {
    const result = <span class="cstat-no" title="statement not covered" >secp256k1.ecdsaRecover(signature, recovery, message, compressed);</span>
<span class="cstat-no" title="statement not covered" >    return Buffer.from(result);</span>
}
&nbsp;
/**
 ...
 * @returns the 33-byte compressed or 65-byte uncompressed public key point
 */
export function publicKeyCombine(pubkeys: Buffer[], compressed: boolean = <span class="branch-0 cbranch-no" title="branch not covered" >true)</span>: Buffer {
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Nov 07 2022 14:49:31 GMT-0500 (Eastern Standard Time)
            </div>
        </div>
