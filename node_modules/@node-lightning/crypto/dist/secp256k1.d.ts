 ...
 */
export declare function ecdh(publicKey: Buffer, privateKey: Buffer): Buffer;
/**
 ...
 */
export declare function privateKeyMul(secret: Buffer, tweak: Buffer): Buffer;
/**
 ...
 */
export declare function sign(msg: Buffer, privateKey: Buffer): Buffer;
/**
 * Create an ECDSA signature for the 32-byte message using the private
 ...
 * @param privateKey 32-byte secp256k1 private key
 */
export declare function signWithRecovery(msg: Buffer, privateKey: Buffer): {
    signature: Buffer;
    recovery: number;
};
/**
 ...
 */
export declare function sigToDER(sig: Buffer): Buffer;
/**
 ...
 */
export declare function verifySig(msg: Buffer, sig: Buffer, pubkey: Buffer): boolean;
/**
 * Returns true if the signature is a DER encoded signature
 * @param sig a DER encoded signature
 */
export declare function isDERSig(sig: Buffer): boolean;
/**
 ...
 */
export declare function recoverPubKey(signature: Buffer, recovery: number, message: Buffer, compressed?: boolean): Buffer;
/**
 ...
 * @returns the 33-byte compressed or 65-byte uncompressed public key point
 */
export declare function publicKeyTweakMul(publicKey: Buffer, tweak: Buffer, compressed?: boolean): Buffer;
/**
 ...
 * @returns the 33-byte compressed or 65-byte uncompressed public key point
 */
export declare function publicKeyCombine(pubkeys: Buffer[], compressed?: boolean): Buffer;
/**
 ...
 */
export declare function privateKeyTweakAdd(privateKey: Buffer, tweak: Buffer): Buffer;
/**
 ...
 * @param tweak a 32-byte tweak
 */
export declare function privateKeyTweakMul(privateKey: Buffer, tweak: Buffer): Buffer;
